...
// 별포인트 확인
Future<void> contentStarService(keyCode) async {
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      // 응답 결과가 있는 경우
      if (resultValue == "0000") {
        final List<dynamic> contentStarDataList = resultList['data']
            .map((json) => ContentStarData.fromJson(json))
            .toList();
        contentStarDataController.setContentStarDataList(contentStarDataList);
      }
