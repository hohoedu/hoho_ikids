...
import 'package:hani_booki/screens/booki/booki_goldenbell/booki_goldenbell_screen.dart';
...
Future<void> bookiGoldenbellService(id, keyCode, year) async {
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      // 응답 결과가 있는 경우
      if (resultValue == "0000") {
        List<BookiGoldenbellData> bookiGoldenbellDataList = responseData
            .map((item) => BookiGoldenbellData.fromJson(item))
            .toList();

        final BookiGoldenbellDataController bookiGoldenbellDataController =
            Get.put(BookiGoldenbellDataController());
