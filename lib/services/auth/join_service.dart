...
Future<void> joinService() async {
  String url = dotenv.get('INSERT_2026_URL');
  ...
  final Map<String, dynamic> requestData = {
    ...
    'pname': (joinController.joinDTO.value.parentName),
    'ptel': removeHyphen(joinController.joinDTO.value.parentTel),
    'relationship': joinController.joinDTO.value.relation,
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      if (resultValue == "0000") {
        ...
        loginService(joinController.joinDTO.value.id, joinController.joinDTO.value.password, false);
      }
