...
Future<void> haniGoldenbellService(id, keyCode, year) async {
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      // 응답 결과가 있는 경우
      if (resultValue == "0000") {
        List<HaniGoldenbellData> haniGoldenbellDataList = responseData
            .map((item) => HaniGoldenbellData.fromJson(item))
            .toList();

        final haniGoldenbellDataController =
            Get.put(HaniGoldenbellDataController());
