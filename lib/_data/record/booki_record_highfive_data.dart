...
class BookiRecordHighFiveData {
  ...
  BookiRecordHighFiveData.fromJson(Map<String, dynamic> json)
      : index = json['idx'],
...
class BookiRecordHighfiveDataController extends GetxController {
  final RxList<BookiRecordHighFiveData> _recordHighfiveDataList = <BookiRecordHighFiveData>[].obs;  // RxList로 선언

  void setBookiRecordHighfiveListData(List<BookiRecordHighFiveData> recordHighfiveDataList) {
    _recordHighfiveDataList.assignAll(recordHighfiveDataList);  // RxList에 데이터를 추가
  }
  void clearData() {
    _recordHighfiveDataList.clear();
  }
  RxList<BookiRecordHighFiveData> get recordHighfiveDataList => _recordHighfiveDataList;  // RxList로 반환
}
