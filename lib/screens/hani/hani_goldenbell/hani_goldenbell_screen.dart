...
class _HaniGoldenbellScreenState extends State<HaniGoldenbellScreen> with TickerProviderStateMixin, StarEventMixin<HaniGoldenbellScreen> {
  ...
  void initState() {
    ...
    // final keysToDelete = box.keys.where((k) => k.toString().startsWith('star_done_')).toList();
    // for (final key in keysToDelete) {
    //   box.delete(key);
    // }
    // Logger().d('⭐ [Star] Hive 초기화 완료 | 삭제된 키: $keysToDelete');
