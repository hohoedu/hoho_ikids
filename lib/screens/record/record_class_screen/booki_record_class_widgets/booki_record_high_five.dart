...
class BookiRecordHighFive extends StatefulWidget {
  const BookiRecordHighFive({super.key});

  @override
  State<BookiRecordHighFive> createState() => _BookiRecordHighFiveState();
}

class _BookiRecordHighFiveState extends State<BookiRecordHighFive> {
  final ScrollController _scrollController = ScrollController();
  final recordHighfiveData = Get.find<BookiRecordHighfiveDataController>();
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Text(
                                        recordHighfiveData.recordHighfiveDataList[index].subject,
                                        style: TextStyle(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          addLineBreaks(
                                              recordHighfiveData.recordHighfiveDataList[index].bestContentValue),
                                          style: TextStyle(fontSize: 7.sp, letterSpacing: -0.5),
                                        ),
                                        Padding(
                                          ...
                                          child: Wrap(
                                            ...
                                            children: [
                                              recordHighfiveData.recordHighfiveDataList[index].contentCard1,
                                              recordHighfiveData.recordHighfiveDataList[index].contentCard2,
                                              recordHighfiveData.recordHighfiveDataList[index].contentCard3,
                                              recordHighfiveData.recordHighfiveDataList[index].contentCard4,
                                            ].where((e) => e.isNotEmpty).map((content) {
                                              return Container(
                                                decoration: BoxDecoration(
                                                  color: mBackWhite,
