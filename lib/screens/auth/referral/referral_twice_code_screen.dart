...
class ReferralTwiceCodeScreen extends StatefulWidget {
  final String id;
  final String password;
  final bool isAutoLoginChecked;

  const ReferralTwiceCodeScreen({
    super.key,
    required this.id,
  ...
  @override
  State<ReferralTwiceCodeScreen> createState() =>
      _ReferralTwiceCodeScreenState();
}

class _ReferralTwiceCodeScreenState extends State<ReferralTwiceCodeScreen> {
