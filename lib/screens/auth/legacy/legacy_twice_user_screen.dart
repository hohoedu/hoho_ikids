...
class LegacyTwiceUserScreen extends StatefulWidget {
  final String id;
  final bool isAutoLoginChecked;

  const LegacyTwiceUserScreen({
    super.key,
    required this.id,
  ...
  @override
  State<LegacyTwiceUserScreen> createState() => _LegacyTwiceUserScreenState();
}

class _LegacyTwiceUserScreenState extends State<LegacyTwiceUserScreen> {
