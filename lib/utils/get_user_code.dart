...
Future<void> getUserCode() async {
  String url = dotenv.get('USER_CODE_URL');
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      // 응답 결과가 있는 경우
      if (resultValue == "0000") {
        final List<UserCodeData> userCodeDataList = (resultList['data'] as List)
            .map((json) => UserCodeData.fromJson(json))
            .toList();
        userCodeData.setUserCodeDataList(userCodeDataList);
